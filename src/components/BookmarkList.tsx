...
//     // Create a unique channel name to prevent tab conflicts
...
//           schema: 'public', 
//           table: 'bookmarks',
//           filter: `user_id=eq.${userId}` // If this fails, try removing this line
//         },
//         (payload) => {
...
//       {/* <div className="text-xs font-mono text-gray-400 bg-gray-100 p-2 rounded">
//         Connection: <span className={status === 'SUBSCRIBED' ? 'text-green-600' : 'text-red-600'}>{status}</span>
//       </div> */}
...
//           <div key={bookmark.id} className="p-4 bg-white border rounded-xl flex justify-between items-center group shadow-sm">
//             <div className="truncate pr-4">
//               <p className="font-bold text-slate-800 truncate">{bookmark.title}</p>
//               <p className="text-sm text-blue-500 truncate">{bookmark.url}</p>
//             </div>
//             <button 
//               onClick={() => deleteBookmark(bookmark.id)} 
//               className="text-red-400 hover:text-red-600 font-medium px-3 py-1"
//             >
//               Delete
//             </button>
//           </div>
